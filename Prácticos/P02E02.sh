...
# No, no aparecen... porque no los pushee
# Publicar/Subir los cambios del repositorio local al repositorio remoto de GitHub.
cd libro
git branch -M main
git push -u origin main
# ¿Qué comando se debe ulizar en este caso para poder publicar/subir dichos cambios? ¿Por qué?
# git push, porque yo no inventé git
